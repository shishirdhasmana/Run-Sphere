...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute top-0 left-0 w-[40vw] h-[40vw] bg-brand/10 rounded-full mix-blend-screen filter blur-[100px] animate-float opacity-50" />
      <div className="absolute bottom-0 right-0 w-[40vw] h-[40vw] bg-blue-500/10 rounded-full mix-blend-screen filter blur-[100px] animate-float stagger-2 opacity-50" />
      ...
      <div className="w-full max-w-md z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-text-secondary mt-2">Join RunSphere to start capturing territory</p>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary w-full group !py-4 mt-6">
